...
class User extends amplify_core.Model {
  ...
  const User._internal({required this.id, required name, required age, required gender, required assets, createdAt, updatedAt}): _name = name, _age = age, _gender = gender, _assets = assets, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory User({String? id, required String name, required int age, required String gender, required double assets}) {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'age': _age, 'gender': _gender, 'assets': _assets, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
